<template>
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mx-6 my-6">
        <article v-for="(station, index) in filteredProductions" :key="index" class="relative cursor-pointer hover:scale-105 transition-all duration-300">
...
export default {
    ...
    data() {
        return {
            stations: [
                {
                    name: 'Ordenes de producción con material pendiente',
                    dark: '#005DB5',
                    light: '#C2E1FF',
                ...
                {
                    name: 'Ordenes de producción X Offset',
                    dark: '#56A612',
                    light: '#E4FAD1',
                ...
                {
                    name: 'Ordenes de producción X Pegado',
                    dark: '#D97706',
                    light: '#FFF6CC',
                ...
                {
                    name: 'Ordenes de producción X Hojeado',
                    dark: '#EA580C',
                    light: '#FFE4C4',
                ...
                {
                    name: 'Ordenes de producción X Barniz',
                    dark: '#9333EA',
                    light: '#EBD7FF',
                ...
                {
                    name: 'Ordenes de producción X Corte',
                    dark: '#087F74',
                    light: '#D2FFF2',
                ...
                {
                    name: 'Ordenes de producción X Suaje',
                    dark: '#065F09',
                    light: '#D6F5E3',
                ...
                {
                    name: 'Ordenes de producción en Maquila',
                    dark: '#374151',
                    light: '#ECECEC',
                ...
                {
                    name: 'Ordenes de producción X Realzado',
                    dark: '#64748B',
                    light: '#E1E5EA',
                ...
                {
                    name: 'Ordenes de producción X Pleca',
                    dark: '#C6A317',
                    light: '#FAF2D1',
                ...
                {
                    name: 'Ordenes de producción Inspección',
                    dark: '#A21CAF',
                    light: '#F5D3F8',
                ...
                {
                    name: 'Ordenes de producción X Sellado',
                    dark: '#176799',
                    light: '#D3EAF8',
                ...
                {
                    name: 'Ordenes de producción en X Estampado',
                    dark: '#D00A95',
                    light: '#FDCEEF',
                ...
                {
                    name: 'Ordenes de producción X Serigrafía',
                    dark: '#78350F',
                    light: '#F9E0D2',
                ...
                {
                    name: 'Ordenes de producción X Troquel',
                    dark: '#1E40AF',
                    light: '#D3DCF8',

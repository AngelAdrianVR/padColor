            ...
            stations: [
                {
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Material pendiente'),
                },
                {
                    name: 'Solicitado',
                    dark: '#00A9B5',
                    light: '#bef4f8',
                    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 7.5h-.75A2.25 2.25 0 0 0 4.5 9.75v7.5a2.25 2.25 0 0 0 2.25 2.25h7.5a2.25 2.25 0 0 0 2.25-2.25v-7.5a2.25 2.25 0 0 0-2.25-2.25h-.75m-6 3.75 3 3m0 0 3-3m-3 3V1.5m6 9h.75a2.25 2.25 0 0 1 2.25 2.25v7.5a2.25 2.25 0 0 1-2.25 2.25h-7.5a2.25 2.25 0 0 1-2.25-2.25v-.75" /></svg>',
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Solicitado'),
                },
                {
                    name: 'Maquila',
                    dark: '#374151',
                ...
                },
                {
                    ...
                    dark: '#851f1f',
                    light: '#f4cbcb',
                    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9v6m-4.5 0V9M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>',
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion En pausa'),
                },
                {
                    name: 'X Reproceso',
                    dark: '#482150',
                ...
                },
                {
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Offset'),
                },
                {
                    name: 'X Pegado',
                    dark: '#D97706',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Pegado'),
                },
                {
                    name: 'X Hojeado',
                    dark: '#EA580C',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Hojeado'),
                },
                {
                    name: 'X Barniz',
                    dark: '#9333EA',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Barniz'),
                },
                {
                    name: 'X Corte',
                    dark: '#087F74',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Corte'),
                },
                {
                    name: 'X Suaje',
                    dark: '#065F09',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Suaje'),
                },
                {
                    name: 'X Realzado',
                    dark: '#64748B',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Realzado'),
                },
                {
                    name: 'X Pleca',
                    dark: '#C6A317',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Pleca'),
                },
                {
                    name: 'X Sellado',
                    dark: '#176799',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Sellado'),
                },
                {
                    name: 'X Estampado',
                    dark: '#D00A95',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Estampado'),
                },
                {
                    name: 'X Serigrafía',
                    dark: '#78350F',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Serigrafía'),
                },
                {
                    name: 'X Troquel',
                    dark: '#1E40AF',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion X Troquel'),
                },
                {
                    name: 'Calidad',
                    dark: '#558233',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Calidad'),
                },
                {
                    name: 'Inspección',
                    dark: '#A21CAF',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Inspección'),
                },
                {
                    name: 'Semi terminadas',
                    dark: '#097100',
                    light: '#ccf1c8',
                    icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>',
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Semi terminadas'),
                },
                {
                    name: 'Terminadas',
                    dark: '#3E8202',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Terminadas'),
                },
                {
                    name: 'Canceladas',
                    dark: '#951919',
                    ...
                    show: this.$page.props.auth.user.permissions.includes('Ver en estacion Canceladas'),
                },

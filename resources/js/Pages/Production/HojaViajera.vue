<template>
    ...
    <main class="mx-auto p-px text-[10px]" :class="printing ? 'w-full' : 'w-1/2'">
        ...
        <body>
            <section class="border border-[#D9D9D9] rounded-xl py-px px-3 flex justify-between space-x-7 mb-[2px]">
                ...
                <div class="text-center">
                    ...
                    <input type="text"
                        class="w-20 h-[13px] border border-transparent hover:border-primary rounded-md transition-colors duration-200 focus:ring-0 text-center text-xs">
                    <!-- <p class="text-black"></p> -->
                </div>
            </section>
            <!-- Orden de producción -->
            <section class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                ...
                <div class="border-t border-[#D9D9D9] py-px px-3 flex justify-between space-x-7">
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-32 h-[13px] border border-transparent hover:border-primary rounded-md transition-colors duration-200 focus:ring-0 px-2 text-xs">
                    </div>
                </div>
            </section>
            <!-- Supervisión -->
            ...
            <section class="grid grid-cols-2 gap-x-2">
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        <div class="flex items-center">
                            ...
                            <p class="flex-1 h-[13px] border border-[#D9D9D9]"></p>
                        </div>
                        <div class="flex items-center">
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="flex-1 h-[13px] border border-[#D9D9D9] px-2">
                                {{ production.dfi }}
                            </p>
                        </div>
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                ...
                                <p class="w-[60px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                ...
                                <p class="w-[70px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                <p class="text-[#676777]">Fecha inicio:</p>
                                <p class="w-[62px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-[#676777]">Hora inicio:</p>
                                <p class="w-[62px] h-[13px] border border-[#D9D9D9]"></p>
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                <p class="text-[#676777]">Fecha fin:</p>
                                <p class="w-[75px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-[#676777]">Hora fin:</p>
                                <p class="w-[75px] h-[13px] border border-[#D9D9D9]"></p>
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="flex-1 h-[13px] border border-[#D9D9D9]">
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                <p class="text-[#676777]">Fecha fin:</p>
                                <p class="w-[77px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-[#676777]">Hora fin:</p>
                                <p class="w-[77px] h-[13px] border border-[#D9D9D9]"></p>
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                <p class="text-[#676777]">Fecha inicio:</p>
                                <p class="w-[63px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-[#676777]">Hora inicio:</p>
                                <p class="w-[63px] h-[13px] border border-[#D9D9D9]"></p>
                ...
                <article class="border border-[#D9D9D9] rounded-xl mb-[2px]">
                    ...
                    <div class="border-t border-[#D9D9D9] py-px px-3 space-y-[px]">
                        ...
                        <article class="flex items-center space-x-2">
                            <div class="flex items-center">
                                <p class="text-[#676777]">Fecha fin:</p>
                                <p class="w-[80px] h-[13px] border border-[#D9D9D9]"></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-[#676777]">Hora fin:</p>
                                <p class="w-[80px] h-[13px] border border-[#D9D9D9]"></p>

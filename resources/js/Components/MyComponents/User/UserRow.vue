<template>
    <div class="flex items-center border-b border-grayD9 hover:bg-primarylight pb-2 pt-3 lg:pl-[95px] px-2">
        ...
        <section @click="$inertia.get(route('users.show', user.id))" class="w-full flex flex-col pl-4 lg:pl-6 cursor-pointer">

    ...
    <div v-if="props.dropdown">
        <div>
            ...
            <transition enter-active-class="transition ease-out duration-300"
                ...
                <div v-show="open" class="absolute z-50 rounded-tr-xl rounded-br-xl origin-top-right -right-[192px] translate-y-[-35px]" :class="[widthClass, alignmentClasses]"
